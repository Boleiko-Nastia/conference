                        ...
                        <div class="panel-body">
                            <div class="media">
                                <div class="media-body">
                                    <h4 class="media-heading">Информационное сообщение PMW-2016</h4>
                                    <p class="small">(на русском, *.pdf ~568 kB)</p>
                                </div>
                            </div>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="panel panel-default text-center">
                        ...
                        <div class="panel-body">
                            ...
                            <p class="small">(на русском, *.pdf ~170 kB)</p>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="panel panel-default text-center">
                        ...
                        <div class="panel-body">
                            ...
                            <p class="small">(на русском, *.pdf ~234 kB)</p>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="panel panel-default text-center">
                        ...
                        <div class="panel-body">
                            ...
                            <p class="small">(українською, *.pdf<br> ~573 kB)</p>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="panel panel-default text-center">
                        ...
                        <div class="panel-body">
                            ...
                            <p class="small">(українською, *.pdf<br> ~170 kB)</p>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="panel panel-default text-center">
                        ...
                        <div class="panel-body">
                            ...
                            <p class="small">(українською, *.pdf<br> ~164 kB)</p>
