                        ...
                        <div class="controls">
                            ...
                            <div class="btn-group" role="group">
                                <select name="section" class="btn btn-default">
                                    ...
                                    <option value="Инновации в производстве печатной продукции">Инновации в производстве печатной продукции</option>
                                    <option value="Технические и технологические инновации в упаковочном производстве">Технические и технологические инновации в упаковочном производстве</option>
                                    <option value="Информационные системы и технологии в полиграфии">Информационные системы и технологии в полиграфии</option>
                                    <option value="Технологии обработки цифровых изображений и управление цветом">Технологии обработки цифровых изображений и управление цветом</option>
                                    <option value="Мультимедийные и web-технологии">Мультимедийные и web-технологии</option>
                                    <option value="Разработка приложений для мобильных устройств">Разработка приложений для мобильных устройств</option>
                                    <option value="Компьютерная графика, графический дизайн и трехмерное моделирование">Компьютерная графика, графический дизайн и трехмерное моделирование</option>
                                    <option value="Маркетинг и реклама в полиграфии">Маркетинг и реклама в полиграфии</option>
                                    <option value="Использование новых методов обучения в издательско-полиграфической отрасли...">Использование новых методов обучения в издательско-полиграфической отрасли...</option>
                                </select>
                            </div>
                        </div>
                        <div class="mg-tp-40">
